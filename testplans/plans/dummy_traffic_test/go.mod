module github.com/erik9876/go-libp2p-kad-dht/testplans/plans/dummy_traffic_test

go 1.23.8

require (
	github.com/erik9876/go-libp2p-kad-dht v0.0.0-20250603092225-c3cab3ee690e
