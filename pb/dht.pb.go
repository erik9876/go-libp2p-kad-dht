...
const file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDesc = "" +
	"\n" +
	"0github.com/libp2p/go-libp2p-kad-dht/pb/dht.proto\x12\x06dht.pb\x1a2github.com/libp2p/go-libp2p-record/pb/record.proto\"\xd1\x04\n" +
	"\aMessage\x12/\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1b.dht.pb.Message.MessageTypeR\x04type\x12(\n" +
	"\x0fclusterLevelRaw\x18\n" +
	" \x01(\x05R\x0fclusterLevelRaw\x12\x10\n" +
	"\x03key\x18\x02 \x01(\fR\x03key\x12)\n" +
	"\x06record\x18\x03 \x01(\v2\x11.record.pb.RecordR\x06record\x126\n" +
	"\vcloserPeers\x18\b \x03(\v2\x14.dht.pb.Message.PeerR\vcloserPeers\x12:\n" +
	"\rproviderPeers\x18\t \x03(\v2\x14.dht.pb.Message.PeerR\rproviderPeers\x1al\n" +
	"\x04Peer\x12\x0e\n" +
	...
	"\x0eCANNOT_CONNECT\x10\x03B/Z-github.com/libp2p/go-libp2p-kad-dht/pb;dht_pbb\x06proto3"

var (
	file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDescOnce sync.Once
	file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDescData []byte
)
...
func file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDescGZIP() []byte {
	file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDescOnce.Do(func() {
		file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDesc), len(file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDesc)))
	})
...
func file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDesc), len(file_github_com_libp2p_go_libp2p_kad_dht_pb_dht_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
